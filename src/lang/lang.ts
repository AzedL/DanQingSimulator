const lang = {
  coreAttribute: '核心属性值',
  coreAttributeTip: '不携带丹青核心属性面板值',
  basicDamage: '自身秒伤',
  basicDamageTip: '不携带丹青秒伤',
  coreAttributeExtraGain: '核心属性额外增益',
  coreAttributeExtraGainTip: '法宝 4%，套装，玄器，挖宝铭锋等',
  attributeYield: '属性收益',
  huiXinYield: '会心收益',
  zhuanJingYield: '专精收益',
  tiaoXiYield: '调息收益',
  ...
  cardsCombo: '丹青组合',
  total: '总计',
  coreAttributeDamage: '丹青核心属性秒伤(包含木剑)',
